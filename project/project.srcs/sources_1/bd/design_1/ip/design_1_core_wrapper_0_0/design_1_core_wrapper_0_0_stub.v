...
module design_1_core_wrapper_0_0(rfmode1, rfmode2, rreg1, rreg2, reg_out1, reg_out2, 
  jr_reg, jr_data, wenable, wfmode, wreg, wdata, clk, rstn)
/* synthesis syn_black_box black_box_pad_pin="rfmode1,rfmode2,rreg1[4:0],rreg2[4:0],reg_out1[31:0],reg_out2[31:0],jr_reg[4:0],jr_data[31:0],wenable,wfmode,wreg[4:0],wdata[31:0],clk,rstn" */;
  input rfmode1;
  input rfmode2;
  input [4:0]rreg1;
  input [4:0]rreg2;
