...
module design_1_exec_0_0(enable, done, exec_command, alu_command, pc, addr, 
  rs, rt, sh, wselector, pc_out, data, rd_in, rd_out, araddr, arburst, arcache, arlen, arlock, arprot, arready, 
  arsize, arvalid, rdata, rlast, rready, rresp, rvalid, awaddr, awburst, awcache, awlen, awlock, awprot, 
  awready, awsize, awvalid, bid, bready, bresp, bvalid, wdata, wlast, wready, wstrb, wvalid, clk, rstn)
/* synthesis syn_black_box black_box_pad_pin="enable,done,exec_command[5:0],alu_command[5:0],pc[31:0],addr[31:0],rs[31:0],rt[31:0],sh[4:0],wselector[3:0],pc_out[31:0],data[31:0],rd_in[4:0],rd_out[4:0],araddr[14:0],arburst[1:0],arcache[3:0],arlen[7:0],arlock,arprot[2:0],arready,arsize[2:0],arvalid,rdata[31:0],rlast,rready,rresp[1:0],rvalid,awaddr[14:0],awburst[1:0],awcache[3:0],awlen[7:0],awlock,awprot[2:0],awready,awsize[2:0],awvalid,bid[3:0],bready,bresp[1:0],bvalid,wdata[31:0],wlast,wready,wstrb[63:0],wvalid,clk,rstn" */;
  input enable;
  output done;
