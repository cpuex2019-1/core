...
module design_1_uart_buffer_0_0(renable, rdone, rsize, rdata, wenable, wdone, wsize, 
  wdata, uart_araddr, uart_arready, uart_arvalid, uart_awaddr, uart_awready, uart_awvalid, 
...
/* synthesis syn_black_box black_box_pad_pin="renable,rdone,rsize[1:0],rdata[31:0],wenable,wdone,wsize[1:0],wdata[31:0],uart_araddr[31:0],uart_arready,uart_arvalid,uart_awaddr[31:0],uart_awready,uart_awvalid,uart_bready,uart_bresp[1:0],uart_bvalid,uart_rdata[31:0],uart_rready,uart_rresp[1:0],uart_rvalid,uart_wdata[31:0],uart_wready,uart_wstrb[3:0],uart_wvalid,clk,rstn" */;
  input renable;
  output rdone;
  input [1:0]rsize;
  output [31:0]rdata;
