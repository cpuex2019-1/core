...
/* synthesis syn_black_box black_box_pad_pin="renable,rdone,rdata[31:0],wenable,wdone,wdata[31:0],uart_araddr[12:0],uart_arready,uart_arvalid,uart_awaddr[12:0],uart_awready,uart_awvalid,uart_bready,uart_bresp[1:0],uart_bvalid,uart_rdata[31:0],uart_rready,uart_rresp[1:0],uart_rvalid,uart_wdata[31:0],uart_wready,uart_wstrb[3:0],uart_wvalid,clk,rstn" */;
  input renable;
  output rdone;
  output [31:0]rdata;
  input wenable;
  output wdone;
  input [31:0]wdata;
  output [12:0]uart_araddr;
  input uart_arready;
  output uart_arvalid;
  output [12:0]uart_awaddr;
  input uart_awready;
  output uart_awvalid;
  output uart_bready;
