...
architecture STRUCTURE of design_1_fetch_0_0_fetch is
  ...
  attribute SOFT_HLUTNM of \inst_addr[16]_INST_0_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \inst_addr[16]_INST_0_i_2\ : label is "soft_lutpair0";
...
\inst_addr[0]_INST_0\: unisim.vcomponents.LUT5
    generic map(
      ...
      I0 => next_pc(2),
      I1 => \^q\(0),
      I2 => \inst_addr[16]_INST_0_i_1_n_0\,
      I3 => data1(2),
      I4 => \inst_addr[16]_INST_0_i_2_n_0\,
      O => \^inst_addr\(0)
    );
...
\inst_addr[16]_INST_0\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"AAAACFC0"
    )
        port map (
...
\inst_addr[16]_INST_0_i_2\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"F8"
    )
        port map (
