...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set DIP [ create_bd_port -dir I -from 3 -to 0 -type data DIP ]
  ...
  connect_bd_net -net data_memory_c0_ddr4_ui_clk [get_bd_pins axi_uartlite_0/s_axi_aclk] [get_bd_pins blk_mem_gen_0/clka] [get_bd_pins clk_wiz/clk_out1] [get_bd_pins core_wrapper_0/clk] [get_bd_pins decode_0/clk] [get_bd_pins exec_0/clk] [get_bd_pins fetch_0/clk] [get_bd_pins inst_counter_0/clk] [get_bd_pins rst_data_memory_300M/slowest_sync_clk] [get_bd_pins stall_0/clk] [get_bd_pins uart_buffer_0/clk]
  ...
  connect_bd_net -net decode_0_pc_out [get_bd_pins decode_0/pc_out] [get_bd_pins exec_0/pc] [get_bd_pins inst_counter_0/pc]
  ...
  connect_bd_net -net fetch_0_inst_addr [get_bd_pins blk_mem_gen_1/addra] [get_bd_pins fetch_0/inst_addr]
  ...
  connect_bd_net -net inst_counter_0_sgnl [get_bd_ports LED] [get_bd_pins inst_counter_0/sgnl]
  ...
  connect_bd_net -net write_0_stall_enable [get_bd_pins exec_0/stall_enable] [get_bd_pins inst_counter_0/stall] [get_bd_pins stall_0/stall_enable]
